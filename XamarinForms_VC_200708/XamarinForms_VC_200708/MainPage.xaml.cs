...
using Xamarin.Forms;
using XamarinForms_VC_200708.Uebungen;
...
namespace XamarinForms_VC_200708
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        private void Btn_KlickMich_Clicked(object sender, EventArgs e)
        {
            ...
            DisplayAlert("Hello World", "Moin Moin", "OK", "Abbruch");
            //Neuzuweisung einer UI-Property
            Lbl_Moin.Text = "Moin Moin";
        }
        ...
        private void Btn_ClearList_Clicked(object sender, EventArgs e)
        {
            //Löschen der Liste
            PersonenListe.Clear();
        ...
        private async void Mim_Delete_Clicked(object sender, EventArgs e)
        {
        ...
        private void Button_Clicked(object sender, EventArgs e)
        {
            ...
            Navigation.PushAsync(new AbsoulteRelativeLayout() { Title = "LayoutUebung" });
        ...
        {
            Navigation.PushAsync(new BspNavigation.TabbedPageBsp());
        }

        private void Btn_MessagingCenter_Clicked(object sender, EventArgs e)
        {
